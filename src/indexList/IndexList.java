...
public interface IndexList<T> { 
	...
	/**Returns the integer value corresponding to the capacity 
	 * of the current instance (the length of the internal array). 
	 * @return the integer value of the capacity of the current instance
	**/
	 int capacity(); 
